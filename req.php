...
<div class="container mt-5">
    ...
    <button id="botton3" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modal3">Delete</button>
    <?php endif; ?>
  </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="miModal1Label">Modify</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
    <h1 class="mb-4">Requisition</h1>

    <!-- Select para mostrar las requisiciones -->
    <label for="requisitionSelect" class="form-label">Select a requisition:</label>
    <select id="requisitionSelect" class="form-select mb-3">
        <option value="">Loading...</option>
    </select>

    <!-- Botón para abrir el modal -->
    <button id="modifyButton" class="btn btn-custom" data-bs-toggle="modal" data-bs-target="#editModal" disabled>
        Modify
    </button>  

    <button class="btn btn-custom" id="editProductsButton" data-bs-toggle="modal" data-bs-target="#editProductsModal">Edit Products</button>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="editModalLabel">Modify Requisition</h5>
...
<div class="modal fade" id="editProductsModal" tabindex="-1" aria-labelledby="editProductsModalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="modal3" tabindex="-1" aria-labelledby="modalLabel3" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalLabel3">Delete Requisition</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="formSelectRequisicion3">
                        <div class="mb-3">
                            <label for="selectRequisicion3" class="form-label">Select requisition:</label>
    ...
    <div class="modal fade" id="confirmModal3" tabindex="-1" aria-labelledby="confirmLabel3" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="confirmLabel3">Confirm Delete</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Do you want delete this requisition?</p>
...
<div class="container my-5">
    ...
    <div class="col-md-4">
                    <div class="card mb-4 shadow-sm" onclick="mostrarModal()">
                        <div class="card-body">
                            <h5 class="card-title">ADD NEW REQUISITION</h5>
                            <p class="card-text">CLICK HERE TO ADD A NEW REQUISITION</p>
        ...
        $query = "SELECT id, description, status, requester FROM requisition ORDER BY id DESC";
...
?>
        ...
        <form id="requisitionForm" method="POST" action="procesar_requisicion.php">
            <!-- Campo de folio -->
            <div class="mb-3">
                <label for="folio" class="form-label">ID</label>
            ...
            <div id="productos-container">
                <div class="producto-item row g-3 align-items-center">
                    <div class="col-md-6">
                        <label for="producto-1" class="form-label">Products</label>
                        <select name="productos[]" id="producto-1" class="form-select">
                            <?php echo obtenerProductos($conexion); ?>
                        </select>
                    </div>
                    <div class="col-md-4">
                        <label for="cantidad-1" class="form-label">Quantity</label>
                        <input type="number" name="cantidades[]" id="cantidad-1" class="form-control" min="1" value="1" required>
                    </div>
                    <div class="col-md-2">
                        <button type="button" class="btn btn-danger btn-sm eliminar-producto" disabled>Delete</button>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-3">
                <button type="button" id="agregarProducto" class="btn btn-primary btn-sm">Add another product</button>
            </div>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            agregarProductoBtn.addEventListener("click", () => {
                ...
                newProductoItem.innerHTML = `
                    <div class="col-md-6">
                        <label for="producto-${productoCount}" class="form-label">Product</label>
                        <select name="productos[]" id="producto-${productoCount}" class="form-select">
                            <?php echo obtenerProductos($conexion); ?>
                        </select>
                    </div>
                    <div class="col-md-4">
                        <label for="cantidad-${productoCount}" class="form-label">Quantity</label>
                        <input type="number" name="cantidades[]" id="cantidad-${productoCount}" class="form-control" min="1" value="1" required>
                    </div>
                    <div class="col-md-2">
                        <button type="button" class="btn btn-danger btn-sm eliminar-producto">Delete</button>
                    </div>
                `;
...
// Inicializar el estado del botón editProductsButton como deshabilitado
editProductsButton.disabled = true;
// Habilitar o deshabilitar los botones en función de la selección del select
requisitionSelect.addEventListener("change", () => {
    // Habilitar o deshabilitar el botón 'Modificar' basado en la selección
    modifyButton.disabled = !requisitionSelect.value;
    
    // Habilitar o deshabilitar el botón 'Editar Productos' basado en la selección
    editProductsButton.disabled = !requisitionSelect.value;
});
